...
class DocDetailState extends State<DocDetail> {
  ...
  void _initCtrls() {
    ...
    fqYearCtrl =
        widget.doc.fqYear != null ? intToBool(widget.doc.fqYear) : false;
    fqHalfYearCtrl = widget.doc.fqHalfYear != null
        ? intToBool(widget.doc.fqHalfYear)
        : false;
    fqQuarterCtrl =
        widget.doc.fqQuarter != null ? intToBool(widget.doc.fqQuarter) : false;
    fqMonthCtrl =
        widget.doc.fqMonth != null ? intToBool(widget.doc.fqMonth) : false;
  }
  ...
  void _saveDoc() {
    ...
    widget.doc.fqYear = boolToInt(fqYearCtrl);
    widget.doc.fqHalfYear = boolToInt(fqHalfYearCtrl);
    widget.doc.fqQuarter = boolToInt(fqQuarterCtrl);
                ...
                children: <Widget>[
                  ...
                  Row(children: <Widget>[
                    Expanded(
                      ...
                      validator: (val) =>
                          isValidDate(val) ? null : 'Not a valid future date',
                    )),
                    IconButton(
